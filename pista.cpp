...
void Pista::inserir_na_aterrissagem(int id, int minutos_combustivel, int numero_de_passageiros,string nome_companhia)
{
    if(fila_1.vazia() && fila_2.vazia())//para a primeira inserção
    {
        fila_1.inserir_na_fila(id,minutos_combustivel, numero_de_passageiros, nome_companhia);
    }
    else if (!fila_1.vazia())//para o programa saber como deixar as filas com tamanhos parecidos
    {
        ...
        {
            fila_2.inserir_na_fila(id,minutos_combustivel, numero_de_passageiros, nome_companhia);
        }
    }
